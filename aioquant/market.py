...
class Status:
    ...
    def __init__(self, platform=None, msg=None, timestamp=None):
        """Initialize."""
        self.platform = platform
        self.msg = msg
        self.timestamp = timestamp
...
class ConfigSet:
    ...
    def __init__(self, platform=None, strategy=None, msg=None, timestamp=None):
        """Initialize."""
        self.platform = platform
...
class MarketSubscribe:
    ...
    def __init__(self, market_type, platform, symbol, callback, strategy=None):
        """Initialize."""
        ...
        if market_type == const.CONFIG_SET:
            from aioquant.event import EventConfigSet
            EventConfigSet(ConfigSet(platform, strategy)).subscribe(callback, multi)
        elif market_type == const.MARKET_TYPE_ORDERBOOK:
            ...
            EventStatus(Status(platform)).subscribe(callback, multi)
        elif market_type in [
